...
export default class SmartContractNumberPropertyView extends React.Component<SmartContractNumberPropertyViewProps> implements ISmartContractPropertyView {
